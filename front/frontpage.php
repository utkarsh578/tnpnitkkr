...
<div id="header-wrap">
	<div id="header-container">
		<div id="header">
			...
			<h2 id="log" style="font-size:18px; color:maroon; visibility:hidden; position:absolute; text-align:right; width:0px; height:25px;top:25px; border-top-right-radius:15px; border-bottom-right-radius:15px; border-bottom-left-radius:30px; border-top-left-radius:30px; left:899px; display:block; background-color:white; padding: 8px 8px 10px 10px;"><a id="a" href="#">Log Out</a></h2>
...
<div class="container">
	<section id="content" style="top:5px; left:-150px;">
		...
		<form>
			...
			<div>
				<a href="http://localhost/tnp/addStudentAttendance.php"><input type="button" value="Add" /></a>
			</div>
			<div>
				<a href="http://localhost/tnp/attendanceReport.php"><input type="button" value="View" /></a>
			</div>
		</form><!-- form -->
	...
	<section id="content" style="top:5px; left:275px;">
		<form>
			...
			<div>
				<a href="http://localhost/tnp/addStudentDetail.php"><input type="button" value="Add" /></a>
			</div>
			<div>
				<a href="http://localhost/tnp/searchstudent.php"><input type="button" value="Search" /></a>
			</div>
		</form><!-- form -->
	...
	<section id="content" style="top:5px; left:700px;">
		<form>
			...
			<div>
				<a href="http://localhost/tnp/addcompany1.php"><input type="button" value="Add" /></a>
			</div>
			<div>
				<a href="http://localhost/tnp/viewcompany.php"><input type="button" value="View" /></a>
			</div>
		</form><!-- form -->
	...
	<section id="content" style="top:255px; left:60px;">
		<form>
			...
			<div>
				<a href="http://localhost/tnp/placementgraph.php"><input type="button" value="View" style="left:-80px;"/></a>
			</div>
		</form><!-- form -->
	...
	<section id="content" style="top:255px; left:500px;">
		<form>
			...
			<div>
				<a href="http://localhost/tnp/updatePlacementRecord.php"><input type="button" value="Update" /></a>
			</div>
			<div>
				<a href="http://localhost/tnp/viewStudentPlacedCompany.php"><input type="button" value="View" /></a>
			</div>
		</form><!-- form -->
